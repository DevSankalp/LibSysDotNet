...
class Program
{
    ...
    {
        Console.WriteLine(
            "Welcome to the Library Management System of \n---------------- A P I I T ----------------"
        );
        Thread.Sleep(1000);
        Console.WriteLine();
        ...
        if (enteredUsername == correctUsername && enteredPassword == correctPassword)
        {
            ...
            library.Students.Add(
                new Student("Hannan Munas", "CB011253", "0768535555", "Hannanmunas76@gmail.com")
            );
            library.Students.Add(
                new Student("Shahiru Iduranga", "CB011584", "0743194860", "shahiru@gmail.com")
            );
            library.Students.Add(
                new Student("Lakindu Mudannayake", "CB011327", "0766615482", "lakindu@gmail.com")
            );
            library.Students.Add(
                new Student("Pulditha Wathsal", "CB011498", "0771852120", "Pulditha@gmail.com")
            );

            // Adding books to the library
            library.Books.Add(
                new Book("Rich Dad Poor Dad", "Robert Kiyosaki", "9781612681139", 2425, 1)
            );
